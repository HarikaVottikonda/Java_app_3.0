            ...
            // when { expression {  params.action == 'create' } }
                steps{
                   script{
                       ...
                       sh 'jf rt upload --url http://3.85.117.81:8082/artifactory/ --access-token ${ARTIFACTORY_ACCESS_TOKEN} target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar example-repo-local/'
               }
            }
        }
